...
class Gen3Pokemon:
    ...
    def __speciesname(self, id):
        ...
        return names[id - 1] if 1 <= id <= len(names) else ""
    ...
    def __init__(self, pkm):
        ...
        decrypted_str = "".join(
            [x.decode("ISO-8859-1") if isinstance(x, bytes) else x for x in decrypted]
        )
        ...
        # try:
        #     if "E" in self.substructs and len(self.substructs["E"]) > 28:
        #         met_loc = struct.unpack("<B", self.substructs["E"][28:29])[0]
        #         self.location = self.__locationname(met_loc)
        #     else:
        #         self.location = "Unknown"
        # except Exception as e:
        #     print(f"[LOCATION] Erro ao extrair met location: {e}")
        #     self.location = "Unknown"
        if self.name == "":
